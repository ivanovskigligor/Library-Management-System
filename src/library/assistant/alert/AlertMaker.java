...
public class AlertMaker {
    ...
    public static void showMaterialDialog(StackPane root, Node nodeToBeBlurred, List<Button> list, String header, String body) {
